    ...
    <div className="bg-white">
      <section className="bg-navy text-white py-16">
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          <p className="text-white/70">Free shipping on boot orders within the continental United States.</p>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 space-y-10 text-gray-700 leading-relaxed text-sm">
          ...
          <div className="bg-cream rounded-2xl p-8 text-center">
            ...
            <h2 className="text-xl font-black text-navy mb-2">Free Shipping on Boot Orders</h2>
            <p className="text-gray-600">We offer free standard shipping on boot orders within the continental United States — no minimum purchase required. Apparel-only orders ship for a flat $8.</p>
          </div>
